...
; Music indexes (see audio/music_pointers.asm)
	...
	const MUSIC_GYM_LEADER_BATTLE_SWSH         ; ab
	...
	const MUSIC_PRINTER                        ; b5
	const MUSIC_TITLE_XY                       ; b6
	const MUSIC_RBY_TRAINERBATTLE              ; b7
	const MUSIC_RBY_FINALBATTLE                ; b8
	const MUSIC_FRLG_WILDBATTLE                ; b9
	const MUSIC_FRLG_GYMLEADER                 ; ba
	const MUSIC_FRLG_SEVIIISLANDS              ; bb
	const MUSIC_DPPT_FRONTIERBRAIN             ; bc
	const MUSIC_HGSS_ICEPATH                   ; bd
	const MUSIC_IMAKUNI	  	           ; be
	const MUSIC_GF2_ALONEFIGHTER   	           ; bf
	const MUSIC_TDBL_THUNDERBLADE  	           ; c0
	const MUSIC_TDBL_BURNINGPOINT  	           ; c1
	const MUSIC_QUARTET_ROUND3  	           ; c2
