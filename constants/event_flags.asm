...
; new to this fork
	const EVENT_GOT_PIKACHU_COLORED_PICHU
	const EVENT_FEEBAS_GENTLEMAN_INTRODUCED
	const EVENT_GOT_FEEBAS_FROM_GENTLEMAN
	const EVENT_SAFARI_ZONE_EAST_GIBLE
	const EVENT_FOUGHT_SAFARI_ZONE_GIBLE
	const EVENT_SILPHCO_STEVEN
	const EVENT_SILPHCO_STEVEN_INTRODUCED
	const EVENT_SILPHCO_STEVEN_ASKED_FOR_FORRETRESS
	const EVENT_SHOWED_FORRETRESS_TO_STEVEN
	const EVENT_GOT_BELDUM_FROM_STEVEN
	const EVENT_CINNABAR_VOLCANO_B1F_TORKOAL
	const EVENT_FOUGHT_CINNABAR_VOLCANO_TORKOAL
	const EVENT_GOT_RIOLU_EGG_FROM_RILEY
	const EVENT_LISTENED_TO_RIOLU_EGG_INTRO

	const_next $8ff
DEF NUM_EVENTS EQU const_value ; 2304
