...
SongInfo:
	...
	song_info "Imakuni?", ORIGIN_TCG, COMPOSER_HUDSON, COMPOSER_DANNYE
	song_info "Alone Fighter", ORIGIN_GF2, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Thunder Blade", ORIGIN_TDBL, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Burning Point", ORIGIN_TDBL, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Round 3", ORIGIN_QUARTET, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Round 5", ORIGIN_QUARTET, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Airport", ORIGIN_SHADANC, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Round 1", ORIGIN_AKSW, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Round 2", ORIGIN_ESWAT, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Round 3", ORIGIN_ESWAT, COMPOSER_SEGA, COMPOSER_JOHNNYZ
	song_info "Final Boss", ORIGIN_ESWAT, COMPOSER_SEGA, COMPOSER_JOHNNYZ
