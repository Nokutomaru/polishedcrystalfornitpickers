; Orange Pokémon in water
	...
	wildmon LEVEL_FROM_BADGES + 4, TENTACOOL
	wildmon LEVEL_FROM_BADGES + 6, TENTACOOL
	wildmon LEVEL_FROM_BADGES + 8, TENTACRUEL
	end_water_wildmons
	...
	db 6 percent ; encounter rate
	wildmon LEVEL_FROM_BADGES + 4, SEADRA
	wildmon LEVEL_FROM_BADGES + 6, SEADRA
	wildmon LEVEL_FROM_BADGES + 8, TENTACRUEL
	end_water_wildmons
	...
	db 6 percent ; encounter rate
	wildmon LEVEL_FROM_BADGES + 8, TENTACRUEL
	wildmon LEVEL_FROM_BADGES + 6, MANTINE
	wildmon LEVEL_FROM_BADGES + 4, REMORAID
	end_water_wildmons
