...
JackyGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 10, TOGETIC @ WIDE_LENS
...
FalknerGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 8, NOCTOWL @ TWISTEDSPOON
		tr_moves AIR_SLASH, PSYCHIC_M, HYPNOSIS, DREAM_EATER
	tr_mon LEVEL_FROM_BADGES + 5, GLISCOR @ SCOPE_LENS
		tr_moves SWORDS_DANCE, EARTHQUAKE, X_SCISSOR, NIGHT_SLASH
	tr_mon LEVEL_FROM_BADGES + 7, DODRIO @ SILK_SCARF
	...
	tr_mon LEVEL_FROM_BADGES + 7, HONCHKROW @ BLACKGLASSES
		tr_moves BRAVE_BIRD, NIGHT_SLASH, SUCKER_PUNCH, CONFUSE_RAY
	tr_mon LEVEL_FROM_BADGES + 10, PIDGEOT @ SHARP_BEAK
...
BugsyGroup:
	...
	def_trainer 2, "Bugsy"
	tr_mon LEVEL_FROM_BADGES + 8, HERACROSS @ BLACK_BELT, MALE
		tr_moves MEGAHORN, CROSS_CHOP, ROCK_SMASH, STONE_EDGE
	tr_mon LEVEL_FROM_BADGES + 5, LEDIAN @ KINGS_ROCK, FEMALE
		tr_moves REFLECT, LIGHT_SCREEN, BUG_BUZZ, ICE_PUNCH
	tr_mon LEVEL_FROM_BADGES + 7, YANMEGA @ QUICK_CLAW, FEMALE
if DEF(FAITHFUL)
		tr_moves BUG_BUZZ, AIR_SLASH, ANCIENTPOWER, PROTECT
else
		tr_moves BUG_BUZZ, AIR_SLASH, ANCIENTPOWER, DRAGON_PULSE
endc
	tr_mon LEVEL_FROM_BADGES + 6, PARASECT @ LEFTOVERS, MALE
		tr_moves SPORE, HEALINGLIGHT, SEED_BOMB, X_SCISSOR
	tr_mon LEVEL_FROM_BADGES + 10, PINSIR @ SCOPE_LENS, MALE
...
WhitneyGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 6, STANTLER @ LIGHT_CLAY, FEMALE
		tr_moves REFLECT, LIGHT_SCREEN, DOUBLE_EDGE, ZEN_HEADBUTT
	tr_mon LEVEL_FROM_BADGES + 7, CLEFABLE @ PINK_BOW, FEMALE
		tr_moves CALM_MIND, MOONBLAST, FRESH_SNACK, THUNDER_WAVE
	tr_mon LEVEL_FROM_BADGES + 5, URSARING @ BLACK_BELT, FEMALE
		tr_moves SWORDS_DANCE, CROSS_CHOP, CRUNCH, PLAY_ROUGH
	tr_mon LEVEL_FROM_BADGES + 7, WIGGLYTUFF @ LEFTOVERS, FEMALE
		tr_moves FOCUS_BLAST, HYPER_VOICE, DAZZLINGLEAM, ICE_BEAM
	tr_mon LEVEL_FROM_BADGES + 9, TAUROS @ SILK_SCARF, FEMALE
		tr_moves BULK_UP, EARTHQUAKE, STRENGTH, IRON_TAIL
	tr_mon LEVEL_FROM_BADGES + 10, MILTANK @ BRIGHTPOWDER, FEMALE
		tr_extra SCRAPPY
...
endc
	...
	def_trainer 2, "Morty"
	tr_mon LEVEL_FROM_BADGES + 7, GENGAR @ LEFTOVERS, MALE
if DEF(FAITHFUL)
		tr_extra CURSED_BODY
else
		tr_extra LEVITATE
endc
	...
	tr_mon LEVEL_FROM_BADGES + 5, NINETALES @ CHARCOAL, MALE
	...
	tr_mon LEVEL_FROM_BADGES + 7, MISMAGIUS @ PINK_BOW, MALE
		tr_moves DAZZLINGLEAM, SHADOW_BALL, NASTY_PLOT, THUNDERBOLT
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 9, HAUNTER @ EVIOLITE, MALE
		tr_extra LEVITATE
		tr_moves SHADOW_BALL, SLUDGE_BOMB, DESTINY_BOND, PAIN_SPLIT
else
	tr_mon LEVEL_FROM_BADGES + 9, NOCTOWL @ SHARP_BEAK, MALE
...
endc
	...
	def_trainer 2, "Chuck"
	tr_mon LEVEL_FROM_BADGES + 6, ANNIHILAPE @ DRAGON_FANG, MALE
		tr_extra DEFIANT
	...
	tr_mon LEVEL_FROM_BADGES + 7, HITMONCHAN @ NEVERMELTICE, MALE
		tr_extra IRON_FIST
		tr_moves THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	tr_mon LEVEL_FROM_BADGES + 7, HITMONLEE @ QUICK_CLAW, MALE
		tr_extra RECKLESS
		tr_moves SUCKER_PUNCH, BULK_UP, REVERSAL, HI_JUMP_KICK
	tr_mon LEVEL_FROM_BADGES + 7, HITMONTOP @ KINGS_ROCK, MALE
		tr_extra INTIMIDATE
...
JasmineGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 9, SKARMORY @ LEFTOVERS
		tr_dvs 14 All
		tr_moves SPIKES, SCREECH, DRILL_PECK, STEEL_WING
	tr_mon LEVEL_FROM_BADGES + 7, MAGNEZONE @ MIRACLE_SEED
		tr_moves THUNDERBOLT, HP_GRASS, FLASH_CANNON, EXPLOSION
	tr_mon LEVEL_FROM_BADGES + 8, FORRETRESS @ SOFT_SAND
		tr_dvs 14 All
		tr_moves EARTHQUAKE, GYRO_BALL, EXPLOSION, SPIKES
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 7, MAGNEZONE @ CHARCOAL
		tr_moves THUNDERBOLT, HP_FIRE, FLASH_CANNON, EXPLOSION
else
	tr_mon LEVEL_FROM_BADGES + 7, RHYPERIOR @ SILVERPOWDER
		tr_dvs 14 All
		tr_moves EARTHQUAKE, STONE_EDGE, MEGAHORN, IRON_HEAD
endc
	tr_mon LEVEL_FROM_BADGES + 8, SCIZOR @ METAL_COAT
		tr_dvs 14 All
		tr_moves SWORDS_DANCE, BULLET_PUNCH, PURSUIT, IRON_HEAD
	tr_mon LEVEL_FROM_BADGES + 10, STEELIX @ LEFTOVERS
		tr_dvs 14 All
...
endc
	...
	def_trainer 2, "Clair"
	tr_mon LEVEL_FROM_BADGES + 7, GYARADOS @ BRIGHTPOWDER, FEMALE
	...
	tr_mon LEVEL_FROM_BADGES + 8, DRAGONITE @ LEFTOVERS, FEMALE
		tr_moves OUTRAGE, EXTREMESPEED, FIRE_PUNCH, EARTHQUAKE
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 8, DRAGONITE @ DRAGON_FANG, FEMALE
		tr_moves DRAGON_DANCE, DRAGON_CLAW, WATERFALL, GIGA_IMPACT
else
	tr_mon LEVEL_FROM_BADGES + 8, AMPHAROS @ DRAGON_FANG, FEMALE
		tr_moves THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
...
WillGroup:
	...
	def_trainer 2, "Will"
	tr_mon 67, WYRDEER @ TWISTEDSPOON, MALE
		tr_moves SHADOW_BALL, MEGAHORN, EARTHQUAKE, PSYCHIC_M
	tr_mon 68, JYNX @ BRIGHTPOWDER, FEMALE
		tr_moves NASTY_PLOT, DRAINING_KISS, ICE_BEAM, PSYCHIC_M
	tr_mon 68, EXEGGUTOR @ MIRACLE_SEED, MALE
		tr_moves REFLECT, GIGA_DRAIN, SLEEP_POWDER, PSYCHIC_M
	tr_mon 69, ALAKAZAM @ LUM_BERRY, MALE
		tr_moves HP_FIGHTING, RECOVER, SHADOW_BALL, PSYCHIC_M
	tr_mon 69, SLOWBRO @ WISE_GLASSES, FEMALE
...
BrockGroup:
	...
	def_trainer 2, "Brock"
	tr_mon LEVEL_FROM_BADGES + 9, ONIX @ SOFT_SAND
		tr_moves IRON_HEAD, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	tr_mon LEVEL_FROM_BADGES + 8, RHYPERIOR @ KINGS_ROCK
		tr_moves AVALANCHE, ROCK_SLIDE, EARTHQUAKE, MEGAHORN
	tr_mon LEVEL_FROM_BADGES + 7, OMASTAR @ MYSTIC_WATER
		tr_moves ANCIENTPOWER, SURF, EARTH_POWER, SPIKES
	tr_mon LEVEL_FROM_BADGES + 7, KABUTOPS @ MIRACLE_SEED
		tr_moves SLASH, SURF, ENDURE, GIGA_DRAIN
	tr_mon LEVEL_FROM_BADGES + 8, AERODACTYL @ QUICK_CLAW
		tr_moves STONE_EDGE, EARTHQUAKE, AERIAL_ACE, CRUNCH
	tr_mon LEVEL_FROM_BADGES + 10, GOLEM @ LEFTOVERS
...
MistyGroup:
	...
	def_trainer 2, "Misty"
	tr_mon LEVEL_FROM_BADGES + 8, GOLDUCK @ TWISTEDSPOON
		tr_moves PSYCHIC_M, SCALD, ICE_BEAM, CALM_MIND
	tr_mon LEVEL_FROM_BADGES + 7, QUAGSIRE
		tr_moves EARTHQUAKE, SCALD, RECOVER, TOXIC
	tr_mon LEVEL_FROM_BADGES + 7, KINGLER @ KINGS_ROCK
		tr_moves SWORDS_DANCE, CRABHAMMER, X_SCISSOR, ROCK_SLIDE
	tr_mon LEVEL_FROM_BADGES + 8, LANTURN @ NEVERMELTICE
		tr_moves SURF, THUNDERBOLT, ICE_BEAM, CONFUSE_RAY
	tr_mon LEVEL_FROM_BADGES + 9, OCTILLERY @ CHARCOAL
		tr_moves FIRE_BLAST, ICE_BEAM, HYDRO_PUMP, POWER_WHIP
	tr_mon LEVEL_FROM_BADGES + 10, STARMIE @ LEFTOVERS
...
LtSurgeGroup:
	...
	tr_mon 60, RAICHU @ SITRUS_BERRY, MALE | RAICHU_SURGE_FORM
		tr_evs 36 Atk, 252 SAt
		tr_moves THUNDER_WAVE, QUICK_ATTACK, WILD_CHARGE, THUNDER
	end_trainer

	def_trainer 2, "Lt.Surge"
	tr_mon LEVEL_FROM_BADGES + 9, ELECTIVIRE @ BLACK_BELT, MALE
		tr_moves CROSS_CHOP, THUNDERPUNCH, LIGHT_SCREEN, WILD_CHARGE
	tr_mon LEVEL_FROM_BADGES + 7, ELECTRODE @ SILK_SCARF, MALE
		tr_moves REFLECT, DOUBLE_TEAM, SWIFT, EXPLOSION
	tr_mon LEVEL_FROM_BADGES + 8, JOLTEON @ NEVERMELTICE, MALE
		tr_moves HP_ICE, THUNDER_WAVE, HYPER_VOICE, THUNDERBOLT
	tr_mon LEVEL_FROM_BADGES + 7, MAGNEZONE @ CHARCOAL, MALE
		tr_moves LIGHT_SCREEN, DOUBLE_TEAM, HP_FIRE, THUNDERBOLT
	tr_mon LEVEL_FROM_BADGES + 8, LANTURN @ LEFTOVERS, MALE
		tr_moves SURF, ICE_BEAM, THUNDERBOLT, RECOVER
	tr_mon LEVEL_FROM_BADGES + 10, RAICHU @ BRIGHTPOWDER, MALE | RAICHU_SURGE_FORM
...
JanineGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 8, CROBAT @ KINGS_ROCK
		tr_moves DOUBLE_TEAM, POISON_JAB, AERIAL_ACE, TOXIC
	tr_mon LEVEL_FROM_BADGES + 7, ARIADOS @ QUICK_CLAW
		tr_moves SCARY_FACE, POISON_JAB, MEAN_LOOK, GIGA_DRAIN
	tr_mon LEVEL_FROM_BADGES + 7, QWILFISH @ FOCUS_BAND
		tr_moves AQUA_TAIL, POISON_JAB, SPIKES, EXPLOSION
	tr_mon LEVEL_FROM_BADGES + 9, NIDOQUEEN @ LEFTOVERS
		tr_moves EARTHQUAKE, HEALINGLIGHT, SLUDGE_BOMB, ICE_BEAM
	tr_mon LEVEL_FROM_BADGES + 8, WEEZING @ CHARCOAL
		tr_moves SLUDGE_BOMB, FIRE_BLAST, WILL_O_WISP, EXPLOSION
	tr_mon LEVEL_FROM_BADGES + 10, VENOMOTH @ BRIGHTPOWDER
...
SabrinaGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 9, ESPEON @ LEFTOVERS
	...
	tr_mon LEVEL_FROM_BADGES + 8, FARIGIRAF @ BRIGHTPOWDER
		tr_moves NASTY_PLOT, SHADOW_BALL, HYPER_VOICE, PSYCHIC_M
	tr_mon LEVEL_FROM_BADGES + 7, HYPNO @ TWISTEDSPOON
		tr_moves NASTY_PLOT, PSYCHIC_M, HYPNOSIS, FUTURE_SIGHT
	tr_mon LEVEL_FROM_BADGES + 9, SLOWKING @ KINGS_ROCK
		tr_moves THUNDER_WAVE, NASTY_PLOT, SCALD, PSYCHIC_M
	tr_mon LEVEL_FROM_BADGES + 10, ALAKAZAM @ FOCUS_BAND
...
BlaineGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 6, MAGCARGO @ FOCUS_BAND
		tr_moves RECOVER, SHELL_SMASH, FLAME_CHARGE, ROCK_SLIDE
	tr_mon LEVEL_FROM_BADGES + 7, MAGMORTAR @ BLACK_BELT
		tr_moves SUNNY_DAY, FOCUS_BLAST, FIRE_BLAST, FLASH_CANNON
	tr_mon LEVEL_FROM_BADGES + 8, ARCANINE @ KINGS_ROCK
		tr_moves CRUNCH, FLAME_CHARGE, FLARE_BLITZ, EXTREMESPEED
	tr_mon LEVEL_FROM_BADGES + 9, FLAREON @ CHARCOAL
		tr_moves WILL_O_WISP, FLARE_BLITZ, DOUBLE_EDGE, SCARY_FACE
	tr_mon LEVEL_FROM_BADGES + 7, TYPHLOSION @ LEFTOVERS
		tr_moves FIRE_BLAST, FOCUS_BLAST, EARTH_POWER, HIDDEN_POWER
	tr_mon LEVEL_FROM_BADGES + 10, RAPIDASH @ POISON_BARB
...
endc
	...
	def_trainer 2, "Blue"
	tr_mon LEVEL_FROM_BADGES + 13, UMBREON @ BRIGHTPOWDER
		tr_moves CONFUSE_RAY, TOXIC, FEINT_ATTACK, PROTECT
	tr_mon LEVEL_FROM_BADGES + 12, MACHAMP @ BLACK_BELT
		tr_moves CROSS_CHOP, EARTHQUAKE, STONE_EDGE, THUNDERPUNCH
	tr_mon LEVEL_FROM_BADGES + 13, KABUTOPS @ HARD_STONE
		tr_moves SLASH, SURF, STONE_EDGE, GIGA_DRAIN
	tr_mon LEVEL_FROM_BADGES + 13, EXEGGUTOR @ MIRACLE_SEED
		tr_moves PSYCHIC_M, LEECH_SEED, SEED_BOMB, GIGA_DRAIN
	tr_mon LEVEL_FROM_BADGES + 13, ARCANINE @ CHARCOAL
		tr_moves ROAR, OUTRAGE, FLARE_BLITZ, EXTREMESPEED
	tr_mon LEVEL_FROM_BADGES + 14, BLASTOISE @ LEFTOVERS
...
Rival2Group:
	...
	def_trainer 1, "<RIVAL>"
	tr_mon LEVEL_FROM_BADGES + 5, WEAVILE @ KINGS_ROCK
		tr_evs 252 Atk, 204 Spe
		tr_moves SWORDS_DANCE, ICE_PUNCH, SLASH, CRUNCH
	tr_mon LEVEL_FROM_BADGES + 6, GOLBAT @ EVIOLITE
	...
	tr_mon LEVEL_FROM_BADGES + 7, GENGAR @ SPELL_TAG
		tr_evs 252 SAt, 204 Spe
		tr_moves MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	tr_mon LEVEL_FROM_BADGES + 7, ALAKAZAM @ BRIGHTPOWDER
		tr_evs 252 SAt, 204 Spe
		tr_moves DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	tr_mon LEVEL_FROM_BADGES + 9, MEGANIUM @ MIRACLE_SEED
		tr_evs 252 Atk, 204 Spe
	...
	tr_mon LEVEL_FROM_BADGES + 7, ALAKAZAM @ BRIGHTPOWDER
		tr_evs 252 SAt, 204 Spe
		tr_moves DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	tr_mon LEVEL_FROM_BADGES + 9, TYPHLOSION @ CHARCOAL
	...
	tr_mon LEVEL_FROM_BADGES + 7, ALAKAZAM @ BRIGHTPOWDER
		tr_evs 252 SAt, 204 Spe
		tr_moves DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	tr_mon LEVEL_FROM_BADGES + 9, FERALIGATR @ MYSTIC_WATER
		tr_evs 204 Atk, 252 Spe
		tr_moves WATERFALL, CRUNCH, SLASH, SCARY_FACE
	end_trainer

	def_trainer 4, "<RIVAL>"
	tr_mon LEVEL_FROM_BADGES + 10, WEAVILE @ KINGS_ROCK
		tr_moves SWORDS_DANCE, ICE_PUNCH, SLASH, CRUNCH
	tr_mon LEVEL_FROM_BADGES + 11, CROBAT @ POISON_BARB
		tr_moves POISON_JAB, CRUNCH, CONFUSE_RAY, TOXIC
	tr_mon LEVEL_FROM_BADGES + 10, MAGNEZONE @ MAGNET
		tr_moves THUNDERBOLT, TRI_ATTACK, THUNDER_WAVE, FLASH_CANNON
	tr_mon LEVEL_FROM_BADGES + 12, GENGAR @ SPELL_TAG
		tr_moves THUNDERBOLT, FOCUS_BLAST, SHADOW_BALL, CONFUSE_RAY
	tr_mon LEVEL_FROM_BADGES + 12, ALAKAZAM @ BRIGHTPOWDER
		tr_moves RECOVER, TRI_ATTACK, PSYCHIC_M, REFLECT
	tr_mon LEVEL_FROM_BADGES + 14, MEGANIUM @ LEFTOVERS
	...
	tr_mon LEVEL_FROM_BADGES + 12, ALAKAZAM @ BRIGHTPOWDER
		tr_moves RECOVER, TRI_ATTACK, PSYCHIC_M, REFLECT
	tr_mon LEVEL_FROM_BADGES + 14, FERALIGATR @ LEFTOVERS
...
=======
	tr_mon LEVEL_FROM_BADGES + 12, RATICATE @ FLAME_ORB, MALE
...
=======
	tr_mon LEVEL_FROM_BADGES + 19, RATICATE @ FLAME_ORB, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 19, RATICATE @ FLAME_ORB, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
=======
	tr_mon LEVEL_FROM_BADGES + 10, NIDOKING @ LIFE_ORB, MALE
		tr_extra SHEER_FORCE, SPE_UP_ATK_DOWN
		tr_moves SLUDGE_BOMB, EARTH_POWER, ICE_BEAM, FLAMETHROWER
	tr_mon LEVEL_FROM_BADGES + 8, DUGTRIO @ CHOICE_BAND, MALE
		tr_extra ARENA_TRAP, SPE_UP_SATK_DOWN
		tr_moves EARTHQUAKE, STONE_EDGE, SUCKER_PUNCH, TOXIC
	tr_mon LEVEL_FROM_BADGES + 6, HONCHKROW @ FOCUS_SASH, FEMALE
		tr_extra MOXIE, ATK_UP_SATK_DOWN
		tr_moves SUCKER_PUNCH, DRILL_PECK, ROOST, THUNDER_WAVE
if !DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 6, KANGASKHAN @ LUM_BERRY, FEMALE
		tr_extra PARENTAL_BOND, SPE_UP_SATK_DOWN
		tr_moves BODY_SLAM, SEISMIC_TOSS, ICE_PUNCH, CRUNCH
else
	tr_mon LEVEL_FROM_BADGES + 6, KANGASKHAN @ LEFTOVERS, FEMALE
		tr_extra EARLY_BIRD, ATK_UP_SATK_DOWN
		tr_moves DOUBLE_EDGE, EARTHQUAKE, CRUNCH, REST
endc
	tr_mon LEVEL_FROM_BADGES + 8, RHYDON @ EVIOLITE, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 10, NIDOKING @ LIFE_ORB, MALE
		tr_extra SHEER_FORCE, SPE_UP_ATK_DOWN
...
=======
	tr_mon LEVEL_FROM_BADGES + 10, NIDOQUEEN @ LIFE_ORB, FEMALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 10, NIDOQUEEN @ LIFE_ORB, FEMALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
ProfIvyGroup:
	...
	def_trainer 1, "Ivy"
	tr_mon LEVEL_FROM_BADGES + 19, BUTTERFREE
	tr_mon LEVEL_FROM_BADGES + 20, POLITOED
	tr_mon LEVEL_FROM_BADGES + 20, VICTREEBEL
	tr_mon LEVEL_FROM_BADGES + 19, RHYPERIOR
...
TowerTycoonGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 9, GYARADOS @ MUSCLE_BAND
		tr_moves DRAGON_DANCE, WATERFALL, CRUNCH, OUTRAGE
	tr_mon LEVEL_FROM_BADGES + 9, RHYPERIOR @ KINGS_ROCK
		tr_moves EARTHQUAKE, ROCK_SLIDE, MEGAHORN, AVALANCHE
	tr_mon LEVEL_FROM_BADGES + 10, DRAGONITE @ WISE_GLASSES
		tr_moves HURRICANE, DRAGON_PULSE, FIRE_BLAST, BLIZZARD
	tr_mon LEVEL_FROM_BADGES + 8, ALAKAZAM @ TWISTEDSPOON
		tr_moves PSYCHIC_M, CONFUSE_RAY, TRI_ATTACK, LIGHT_SCREEN
	tr_mon LEVEL_FROM_BADGES + 8, SNORLAX @ LEFTOVERS
		tr_moves SLEEP_TALK, REST, BODY_SLAM, GUNK_SHOT
	tr_mon LEVEL_FROM_BADGES + 7, HERACROSS @ BLACK_BELT
...
LoreleiGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 5, GLACEON
		tr_evs 240 Spe
		tr_moves ICE_BEAM, BARRIER, RECOVER, QUICK_ATTACK
	tr_mon LEVEL_FROM_BADGES + 7, DEWGONG
		tr_evs 240 HP
		tr_moves WATERFALL, AURORA_BEAM, SLEEP_TALK, REST
	tr_mon LEVEL_FROM_BADGES + 6, CLOYSTER
		tr_evs 240 Atk
	...
	tr_mon LEVEL_FROM_BADGES + 7, CLOYSTER @ SILK_SCARF
		tr_evs 252 Atk, 68 Spe
...
endc
	...
	tr_mon LEVEL_FROM_BADGES + 8, GENGAR @ SPELL_TAG, FEMALE | GENGAR_AGATHA_FORM
		tr_moves SHADOW_BALL, WILL_O_WISP, CURSE, DESTINY_BOND
	tr_mon LEVEL_FROM_BADGES + 8, CROBAT @ MUSCLE_BAND, FEMALE
		tr_moves AIR_SLASH, CRUNCH, X_SCISSOR, POISON_JAB
	tr_mon LEVEL_FROM_BADGES + 7, MISMAGIUS @ CHARCOAL, FEMALE
		tr_moves SHADOW_BALL, FLAMETHROWER, DAZZLINGLEAM, POWER_GEM
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 7, MUK @ SILK_SCARF, FEMALE
		tr_moves EXPLOSION, SLUDGE_BOMB, SCREECH, MINIMIZE
else
	tr_mon LEVEL_FROM_BADGES + 7, MAROWAK @ THICK_CLUB, FEMALE | ALOLAN_FORM
		tr_moves SWORDS_DANCE, BONEMERANG, ROCK_SMASH, SHADOW_CLAW
endc
	tr_mon LEVEL_FROM_BADGES + 9, ARBOK @ KINGS_ROCK, FEMALE | ARBOK_AGATHA_FORM
		tr_moves SLUDGE_BOMB, GLARE, CRUNCH, BODY_SLAM
	tr_mon LEVEL_FROM_BADGES + 12, GENGAR @ WISE_GLASSES, FEMALE | GENGAR_AGATHA_FORM
		tr_moves SHADOW_BALL, THUNDERBOLT, WILL_O_WISP, DESTINY_BOND
	end_trainer
...
StevenGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 13, SKARMORY @ QUICK_CLAW, MALE
		tr_moves SPIKES, SCREECH, DRILL_PECK, STEEL_WING
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 11, MAGNEZONE @ WISE_GLASSES, MALE
...
endc
	...
	tr_mon LEVEL_FROM_BADGES + 20, SKARMORY @ QUICK_CLAW, MALE
		tr_moves SPIKES, SCREECH, DRILL_PECK, STEEL_WING
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 19, STEELIX @ MUSCLE_BAND, MALE
		tr_moves EARTHQUAKE, STONE_EDGE, IRON_HEAD, SANDSTORM
else
	tr_mon LEVEL_FROM_BADGES + 19, RHYPERIOR @ FOCUS_BAND, MALE
		tr_moves EARTHQUAKE, STONE_EDGE, MEGAHORN, IRON_HEAD
endc
	tr_mon LEVEL_FROM_BADGES + 17, MAGNEZONE @ WISE_GLASSES, MALE
		tr_moves THUNDERBOLT, FLASH_CANNON, TRI_ATTACK, EXPLOSION
	tr_mon LEVEL_FROM_BADGES + 17, SANDSLASH @ NEVERMELTICE, MALE | ALOLAN_FORM
		tr_moves IRON_HEAD, ICICLE_CRASH, EARTHQUAKE, RAPID_SPIN
	tr_mon LEVEL_FROM_BADGES + 18, AERODACTYL @ KINGS_ROCK, MALE
		tr_moves ROCK_SLIDE, CRUNCH, AERIAL_ACE, IRON_HEAD
...
<<<<<<< HEAD
	...
	tr_mon LEVEL_FROM_BADGES + 10, LEAFEON @ FOCUS_BAND, FEMALE
...
=======
	tr_mon LEVEL_FROM_BADGES + 13, TOGEKISS @ WISE_GLASSES, MALE | TOGEKISS_CYNTHIA_FORM
		tr_moves AIR_SLASH, AURA_SPHERE, FRESH_SNACK, NASTY_PLOT
	tr_mon LEVEL_FROM_BADGES + 10, LEAFEON @ FOCUS_BAND, FEMALE
		tr_moves SWORDS_DANCE, SEED_BOMB, DOUBLE_EDGE, ROAR
=======
	...
	tr_mon LEVEL_FROM_BADGES + 10, LEAFEON @ FOCUS_BAND, FEMALE
		tr_moves SWORDS_DANCE, SEED_BOMB, DOUBLE_EDGE, ROAR
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	tr_mon LEVEL_FROM_BADGES + 10, ELECTIVIRE @ MUSCLE_BAND, MALE
		tr_moves CROSS_CHOP, THUNDERPUNCH, FIRE_PUNCH, LIGHT_SCREEN
	tr_mon LEVEL_FROM_BADGES + 12, MILOTIC @ LEFTOVERS, FEMALE
		tr_moves ICE_BEAM, REST, SLEEP_TALK, SURF
<<<<<<< HEAD
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 21, TOGEKISS @ WISE_GLASSES, MALE
		tr_moves AIR_SLASH, AURA_SPHERE, FRESH_SNACK, NASTY_PLOT
	tr_mon LEVEL_FROM_BADGES + 17, LEAFEON @ FOCUS_BAND, FEMALE
		tr_moves SWORDS_DANCE, SEED_BOMB, DOUBLE_EDGE, ROAR
	tr_mon LEVEL_FROM_BADGES + 17, LUCARIO @ LIFE_ORB, MALE
		tr_moves SWORDS_DANCE, METAL_CLAW, EXTREMESPEED, CLOSE_COMBAT
=======
	tr_mon LEVEL_FROM_BADGES + 21, TOGEKISS @ WISE_GLASSES, MALE | TOGEKISS_CYNTHIA_FORM
		tr_moves AIR_SLASH, AURA_SPHERE, FRESH_SNACK, NASTY_PLOT
	tr_mon LEVEL_FROM_BADGES + 17, LEAFEON @ FOCUS_BAND, FEMALE
		tr_moves SWORDS_DANCE, SEED_BOMB, DOUBLE_EDGE, ROAR
	tr_mon LEVEL_FROM_BADGES + 17, ELECTIVIRE @ MUSCLE_BAND, MALE
		tr_moves CROSS_CHOP, THUNDERPUNCH, FIRE_PUNCH, LIGHT_SCREEN
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 21, TOGEKISS @ WISE_GLASSES, MALE | TOGEKISS_CYNTHIA_FORM
...
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	...
	tr_mon LEVEL_FROM_BADGES + 18, GLISCOR @ KINGS_ROCK, FEMALE
		tr_moves SWORDS_DANCE, NIGHT_SLASH, X_SCISSOR, SCREECH
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 22, GARCHOMP @ FOCUS_SASH, FEMALE
=======
	tr_mon LEVEL_FROM_BADGES + 22, GARCHOMP @ LIFE_ORB, FEMALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 22, GARCHOMP @ LIFE_ORB, FEMALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
CherylGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 8, BLISSEY
	tr_mon LEVEL_FROM_BADGES + 7, NIDOQUEEN
	...
	tr_mon LEVEL_FROM_BADGES + 10, BLISSEY
	tr_mon LEVEL_FROM_BADGES + 9, NIDOQUEEN
	tr_mon LEVEL_FROM_BADGES + 6, CLEFABLE
	tr_mon LEVEL_FROM_BADGES + 6, WIGGLYTUFF
	tr_mon LEVEL_FROM_BADGES + 8, AZUMARILL
	tr_mon LEVEL_FROM_BADGES + 7, WOBBUFFET
	end_trainer
...
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 4, MACHAMP
		tr_evs 252 Atk ; maybe 252 since these are "stat trainers"?
	tr_mon LEVEL_FROM_BADGES + 5, LUCARIO
=======
	tr_mon LEVEL_FROM_BADGES + 5, MACHAMP
		tr_evs 252 Atk ; maybe 252 since these are "stat trainers"?
	tr_mon LEVEL_FROM_BADGES + 4, DRAGONITE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 5, MACHAMP
		tr_evs 252 Atk ; maybe 252 since these are "stat trainers"?
...
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
		tr_evs 252 Atk
	tr_mon LEVEL_FROM_BADGES + 3, RHYPERIOR
		tr_evs 252 Atk
	tr_mon LEVEL_FROM_BADGES + 2, NIDOKING
		tr_evs 252 Atk
	tr_mon LEVEL_FROM_BADGES + 3, ELECTIVIRE
		tr_evs 252 Atk
	tr_mon LEVEL_FROM_BADGES + 2, MAMOSWINE
		tr_evs 252 Atk
	end_trainer
...
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 9, MACHAMP
	tr_mon LEVEL_FROM_BADGES + 10, LUCARIO
=======
	tr_mon LEVEL_FROM_BADGES + 10, MACHAMP
	tr_mon LEVEL_FROM_BADGES + 9, DRAGONITE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 10, MACHAMP
	tr_mon LEVEL_FROM_BADGES + 9, DRAGONITE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	tr_mon LEVEL_FROM_BADGES + 8, RHYPERIOR
	tr_mon LEVEL_FROM_BADGES + 7, NIDOKING
	tr_mon LEVEL_FROM_BADGES + 8, ELECTIVIRE
	tr_mon LEVEL_FROM_BADGES + 7, MAMOSWINE
	end_trainer
...
BuckGroup:
	...
	def_trainer 1, "Buck"
	tr_mon LEVEL_FROM_BADGES + 5, UMBREON
		tr_evs 252 Def ; maybe 252 since these are "stat trainers"?
	tr_mon LEVEL_FROM_BADGES + 4, GOLEM
		tr_evs 252 Def
	tr_mon LEVEL_FROM_BADGES + 2, POLIWRATH
		tr_evs 252 Def
	tr_mon LEVEL_FROM_BADGES + 3, FORRETRESS
		tr_evs 252 Def
	tr_mon LEVEL_FROM_BADGES + 2, SKARMORY
		tr_evs 252 Def
	tr_mon LEVEL_FROM_BADGES + 3, STEELIX
		tr_evs 252 Def
	end_trainer

	def_trainer 2, "Buck"
	tr_mon LEVEL_FROM_BADGES + 10, GOLEM
	tr_mon LEVEL_FROM_BADGES + 7, POLIWRATH
	tr_mon LEVEL_FROM_BADGES + 8, FORRETRESS
	tr_mon LEVEL_FROM_BADGES + 7, SKARMORY
	tr_mon LEVEL_FROM_BADGES + 8, STEELIX
	tr_mon LEVEL_FROM_BADGES + 9, CLOYSTER
	end_trainer
...
MiraGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 4, MAGNEZONE
		tr_evs 252 SAt
	tr_mon LEVEL_FROM_BADGES + 3, PORYGON_Z
		tr_evs 252 SAt
	end_trainer
...
AnabelGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 9, SNORLAX
	tr_mon LEVEL_FROM_BADGES + 10, SLOWKING
	tr_mon LEVEL_FROM_BADGES + 8, BLASTOISE
	tr_mon LEVEL_FROM_BADGES + 6, BELLOSSOM
	tr_mon LEVEL_FROM_BADGES + 7, POLITOED
	tr_mon LEVEL_FROM_BADGES + 8, MR__MIME
	end_trainer
...
=======
	tr_mon LEVEL_FROM_BADGES + 17, NIDOQUEEN
	tr_mon LEVEL_FROM_BADGES + 15, HERACROSS
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 16, MACHAMP
	tr_mon LEVEL_FROM_BADGES + 15, SKARMORY
else
	tr_mon LEVEL_FROM_BADGES + 16, BLASTOISE
	tr_mon LEVEL_FROM_BADGES + 15, FARFETCH_D
endc
	tr_mon LEVEL_FROM_BADGES + 17, MISMAGIUS
	tr_mon LEVEL_FROM_BADGES + 19, HOUNDOOM
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 17, NIDOQUEEN
	tr_mon LEVEL_FROM_BADGES + 15, HERACROSS
...
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	tr_mon LEVEL_FROM_BADGES + 18, ESPEON
	tr_mon LEVEL_FROM_BADGES + 16, XATU
	tr_mon LEVEL_FROM_BADGES + 17, STARMIE
	tr_mon LEVEL_FROM_BADGES + 16, JYNX
	tr_mon LEVEL_FROM_BADGES + 18, ALAKAZAM
	tr_mon LEVEL_FROM_BADGES + 20, HYPNO
<<<<<<< HEAD
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
<<<<<<< HEAD
	...
	tr_mon LEVEL_FROM_BADGES + 11, CHARIZARD, FEMALE
		tr_moves SEISMIC_TOSS, DRAGON_CLAW, EARTHQUAKE, FLAMETHROWER
	tr_mon LEVEL_FROM_BADGES + 12, MAROWAK, FEMALE | ALOLAN_FORM
		tr_moves BONEMERANG, HEX, FIRE_SPIN, WILL_O_WISP
	tr_mon LEVEL_FROM_BADGES + 15, MOLTRES @ HEAT_ROCK, MALE
=======
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	tr_mon LEVEL_FROM_BADGES + 16, FLAREON @ CHARCOAL, FEMALE
		tr_moves BATON_PASS, BITE, DOUBLE_EDGE, FLAME_CHARGE
	tr_mon LEVEL_FROM_BADGES + 15, MAGMORTAR, FEMALE
		tr_moves SUNNY_DAY, FOCUS_BLAST, FIRE_BLAST, FLASH_CANNON
	tr_mon LEVEL_FROM_BADGES + 16, RAPIDASH, FEMALE
		tr_moves EXTREMESPEED, DOUBLE_KICK, PLAY_ROUGH, FLARE_BLITZ
	tr_mon LEVEL_FROM_BADGES + 14, CHARIZARD, FEMALE
		tr_moves SEISMIC_TOSS, DRAGON_CLAW, EARTHQUAKE, FLAMETHROWER
	tr_mon LEVEL_FROM_BADGES + 15, MAROWAK, FEMALE | ALOLAN_FORM
		tr_moves BONEMERANG, HEX, FIRE_SPIN, WILL_O_WISP
...
if DEF(FAITHFUL)
		...
		tr_moves FLAMETHROWER, AIR_SLASH, SOLAR_BEAM, SUNNY_DAY
else
		tr_extra DROUGHT, SATK_UP_ATK_DOWN
		tr_moves FLAMETHROWER, AIR_SLASH, SOLAR_BEAM, SUNNY_DAY
endc
...
<<<<<<< HEAD
	...
	tr_mon LEVEL_FROM_BADGES + 12, LAPRAS, MALE
		tr_moves SURF, CONFUSE_RAY, ANCIENTPOWER, ICE_BEAM
	...
	tr_mon LEVEL_FROM_BADGES + 12, STARMIE, MALE
		tr_moves BUBBLE_BEAM, POWER_GEM, GYRO_BALL, ICE_BEAM
	tr_mon LEVEL_FROM_BADGES + 15, ARTICUNO @ ICY_ROCK, MALE
=======
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	tr_mon LEVEL_FROM_BADGES + 16, GLACEON @ NEVERMELTICE, MALE
		tr_moves HYPER_VOICE, DIG, BARRIER, ICY_WIND
	tr_mon LEVEL_FROM_BADGES + 15, LAPRAS, MALE
		tr_moves SURF, CONFUSE_RAY, ANCIENTPOWER, ICE_BEAM
	tr_mon LEVEL_FROM_BADGES + 16, NINETALES, FEMALE | ALOLAN_FORM
		tr_moves HAIL, SHADOW_BALL, EXTRASENSORY, BLIZZARD
	tr_mon LEVEL_FROM_BADGES + 14, JYNX, FEMALE
		tr_moves DRAINING_KISS, PSYBEAM, PERISH_SONG, ICY_WIND
	tr_mon LEVEL_FROM_BADGES + 15, STARMIE, MALE
		tr_moves BUBBLE_BEAM, POWER_GEM, GYRO_BALL, ICE_BEAM
	tr_mon LEVEL_FROM_BADGES + 18, ARTICUNO @ ICY_ROCK, MALE
<<<<<<< HEAD
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
<<<<<<< HEAD
	...
	tr_mon LEVEL_FROM_BADGES + 11, MAGNEZONE, MALE
...
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	tr_mon LEVEL_FROM_BADGES + 16, JOLTEON @ MAGNET, MALE
		tr_moves VOLT_SWITCH, LIGHT_SCREEN, MUD_SLAP, DAZZLINGLEAM
	tr_mon LEVEL_FROM_BADGES + 15, ELECTIVIRE, MALE
		tr_moves THUNDERPUNCH, ROCK_SMASH, ROCK_SLIDE, EARTHQUAKE
	tr_mon LEVEL_FROM_BADGES + 14, MAGNEZONE, MALE
		tr_moves HYPER_BEAM, FLASH_CANNON, TRI_ATTACK, ZAP_CANNON
	tr_mon LEVEL_FROM_BADGES + 16, RAICHU, MALE | ALOLAN_FORM
		tr_moves THUNDERBOLT, PSYCHIC_M, SURF, REFLECT
	tr_mon LEVEL_FROM_BADGES + 17, PIKACHU @ LIGHT_BALL, MALE | PIKACHU_SPARK_FORM
		tr_moves THUNDERBOLT, EXTREMESPEED, PETAL_DANCE, DOUBLE_TEAM
	tr_mon LEVEL_FROM_BADGES + 18, "Fearow", ZAPDOS @ DAMP_ROCK, MALE
<<<<<<< HEAD
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
FlanneryGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 7, MAGCARGO
<<<<<<< HEAD
<<<<<<< HEAD
	...
	tr_mon LEVEL_FROM_BADGES + 5, HOUNDOOM
	...
	tr_mon LEVEL_FROM_BADGES + 3, NINETALES
		tr_evs 172 SAt, 252 Spe
		tr_moves HYPNOSIS, DREAM_EATER, SHADOW_BALL, FLAMETHROWER
	tr_mon LEVEL_FROM_BADGES + 9, TORKOAL
		tr_evs 172 HP, 252 SDf
		tr_moves FIRE_BLAST, SLUDGE_BOMB, EARTHQUAKE, ROLLOUT
	end_trainer

	def_trainer 2, "Flannery"
	tr_mon LEVEL_FROM_BADGES + 12, MAGCARGO
		tr_moves FLAMETHROWER, EARTH_POWER, ROCK_SLIDE, AMNESIA
	tr_mon LEVEL_FROM_BADGES + 11, ARCANINE
		tr_moves FIRE_PUNCH, EXTREMESPEED, OUTRAGE, CRUNCH
	tr_mon LEVEL_FROM_BADGES + 11, HOUNDOOM
		tr_moves FLAMETHROWER, DARK_PULSE, THUNDERPUNCH, NASTY_PLOT
	tr_mon LEVEL_FROM_BADGES + 11, RAPIDASH
		tr_moves FLARE_BLITZ, DOUBLE_KICK, MEGAHORN, WILD_CHARGE
	tr_mon LEVEL_FROM_BADGES + 10, NINETALES
		tr_moves EXTRASENSORY, ENERGY_BALL, SHADOW_BALL, FLAMETHROWER
	tr_mon LEVEL_FROM_BADGES + 13, TORKOAL
		tr_moves FIRE_BLAST, SLUDGE_BOMB, EARTHQUAKE, ANCIENTPOWER
=======
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
	...
	tr_mon LEVEL_FROM_BADGES + 3, NINETALES
		tr_evs 172 SAt, 252 Spe
	tr_mon LEVEL_FROM_BADGES + 9, MAGMORTAR
		tr_evs 172 HP, 252 Spe
	end_trainer

	def_trainer 2, "Flannery"
	tr_mon LEVEL_FROM_BADGES + 9, MAGCARGO
	tr_mon LEVEL_FROM_BADGES + 8, ARCANINE
	tr_mon LEVEL_FROM_BADGES + 8, HOUNDOOM
	tr_mon LEVEL_FROM_BADGES + 8, RAPIDASH
	tr_mon LEVEL_FROM_BADGES + 7, NINETALES
	tr_mon LEVEL_FROM_BADGES + 10, MAGMORTAR
<<<<<<< HEAD
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
...
MayleneGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 5, HITMONTOP
		tr_evs 140 Atk, 252 Spe
	tr_mon LEVEL_FROM_BADGES + 5, HITMONLEE
		tr_evs 252 Atk, 140 Spe
	tr_mon LEVEL_FROM_BADGES + 5, HITMONCHAN
		tr_evs 196 Atk, 196 Spe
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 7, HERACROSS
		tr_evs 140 Atk, 252 Spe
	tr_mon LEVEL_FROM_BADGES + 7, PRIMEAPE
		tr_evs 140 Atk, 252 Spe ; faithful, so no Gorilla Tactics
else
	tr_mon LEVEL_FROM_BADGES + 7, ELECTIVIRE
		tr_evs 140 Atk, 252 Spe
	tr_mon LEVEL_FROM_BADGES + 7, MAGMORTAR
...
endc
	...
	tr_mon LEVEL_FROM_BADGES + 7, HITMONTOP
	tr_mon LEVEL_FROM_BADGES + 7, HITMONLEE
	tr_mon LEVEL_FROM_BADGES + 7, HITMONCHAN
if DEF(FAITHFUL)
...
MarlonGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 4, QUAGSIRE
		tr_evs 200 SDf
	tr_mon LEVEL_FROM_BADGES + 7, TENTACRUEL
		tr_evs 200 Spe
	tr_mon LEVEL_FROM_BADGES + 5, BLASTOISE
		tr_evs 200 HP
	tr_mon LEVEL_FROM_BADGES + 6, MANTINE
		tr_evs 200 Def
	tr_mon LEVEL_FROM_BADGES + 4, STARMIE
	...
	tr_mon LEVEL_FROM_BADGES + 9, TENTACRUEL
		tr_evs 68 SAt, 252 Spe
	tr_mon LEVEL_FROM_BADGES + 7, BLASTOISE
		tr_evs 252 HP, 68 SAt
	tr_mon LEVEL_FROM_BADGES + 8, MANTINE
	...
	tr_mon LEVEL_FROM_BADGES + 7, QUAGSIRE
	tr_mon LEVEL_FROM_BADGES + 10, TENTACRUEL
	tr_mon LEVEL_FROM_BADGES + 8, BLASTOISE
	tr_mon LEVEL_FROM_BADGES + 9, MANTINE
	tr_mon LEVEL_FROM_BADGES + 8, STARMIE
	tr_mon LEVEL_FROM_BADGES + 7, CLOYSTER
	end_trainer
...
ValerieGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 5, MR__MIME
		tr_evs 224 HP
		tr_moves PSYBEAM, CONFUSE_RAY, LIGHT_SCREEN, REFLECT
	tr_mon LEVEL_FROM_BADGES + 4, AZUMARILL
		tr_evs 224 Atk
		tr_moves PLAY_ROUGH, AQUA_TAIL, DIZZY_PUNCH, ROLLOUT
	tr_mon LEVEL_FROM_BADGES + 6, TOGETIC
		tr_evs 224 SAt
		tr_moves ANCIENTPOWER, FRESH_SNACK, DAZZLINGLEAM, ENCORE
	tr_mon LEVEL_FROM_BADGES + 8, SYLVEON @ SITRUS_BERRY
		tr_evs 224 SAt
	...
	tr_mon LEVEL_FROM_BADGES + 8, CLEFABLE @ LEFTOVERS, FEMALE
		tr_moves MOONBLAST, CALM_MIND, FRESH_SNACK, THUNDER_WAVE
	tr_mon LEVEL_FROM_BADGES + 8, MR__MIME @ QUICK_CLAW, FEMALE
		tr_moves PSYCHIC_M, DAZZLINGLEAM, LIGHT_SCREEN, REFLECT
	tr_mon LEVEL_FROM_BADGES + 7, AZUMARILL @ MUSCLE_BAND, FEMALE
		tr_moves PLAY_ROUGH, WATERFALL, RETURN, CLOSE_COMBAT
	tr_mon LEVEL_FROM_BADGES + 7, RAPIDASH @ KINGS_ROCK, FEMALE | GALARIAN_FORM
		tr_moves FIRE_BLAST, ZEN_HEADBUTT, PLAY_ROUGH, WILD_CHARGE
	tr_mon LEVEL_FROM_BADGES + 9, TOGEKISS @ WISE_GLASSES, FEMALE
		tr_moves AURA_SPHERE, FRESH_SNACK, DAZZLINGLEAM, AIR_SLASH
	tr_mon LEVEL_FROM_BADGES + 10, SYLVEON @ PINK_BOW, FEMALE
		tr_moves MOONBLAST, CALM_MIND, DRAINING_KISS, HYPER_VOICE
	end_trainer
...
KukuiGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 5, RATICATE, MALE | ALOLAN_FORM
		tr_evs 236 Atk, 252 Spe
	tr_mon LEVEL_FROM_BADGES + 8, EXEGGUTOR, MALE | ALOLAN_FORM
		tr_evs 236 SAt, 252 Spe
	end_trainer

	def_trainer 2, "Kukui"
	tr_mon LEVEL_FROM_BADGES + 14, MAROWAK, MALE | ALOLAN_FORM
	tr_mon LEVEL_FROM_BADGES + 12, NINETALES, MALE | ALOLAN_FORM
	tr_mon LEVEL_FROM_BADGES + 13, MAGNEZONE, MALE
	tr_mon LEVEL_FROM_BADGES + 13, SNORLAX, MALE
	tr_mon LEVEL_FROM_BADGES + 12, MUK, MALE | ALOLAN_FORM
	tr_mon LEVEL_FROM_BADGES + 15, EXEGGUTOR, MALE | ALOLAN_FORM
	end_trainer
...
PiersGroup:
	...
	def_trainer 1, "Piers"
	tr_mon LEVEL_FROM_BADGES + 4, MURKROW
	tr_mon LEVEL_FROM_BADGES + 5, QWILFISH, HISUIAN_FORM
	tr_mon LEVEL_FROM_BADGES + 5, MUK, ALOLAN_FORM
	tr_mon LEVEL_FROM_BADGES + 7, RATICATE, ALOLAN_FORM
	end_trainer

	def_trainer 2, "Piers"
	tr_mon LEVEL_FROM_BADGES + 5, HONCHKROW
	tr_mon LEVEL_FROM_BADGES + 9, OVERQWIL
	tr_mon LEVEL_FROM_BADGES + 9, MUK, ALOLAN_FORM
	tr_mon LEVEL_FROM_BADGES + 7, PERSIAN, ALOLAN_FORM
if DEF(FAITHFUL)
	tr_mon LEVEL_FROM_BADGES + 7, UMBREON
else
	tr_mon LEVEL_FROM_BADGES + 7, GIRAFARIG
endc
	tr_mon LEVEL_FROM_BADGES + 12, RATICATE, ALOLAN_FORM
	end_trainer
...
KatyGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 20, KLEAVOR
	tr_mon LEVEL_FROM_BADGES + 18, HERACROSS
	tr_mon LEVEL_FROM_BADGES + 21, URSALUNA
	end_trainer
...
BillGroup:
	...
	def_trainer 1, "Bill"
	tr_mon LEVEL_FROM_BADGES + 4, VAPOREON @ MYSTIC_WATER
		tr_moves RECOVER, BARRIER, HAZE, SCALD
	tr_mon LEVEL_FROM_BADGES + 4, JOLTEON @ MAGNET
		tr_moves THUNDER_WAVE, THUNDERBOLT, LIGHT_SCREEN, QUICK_ATTACK
	tr_mon LEVEL_FROM_BADGES + 4, FLAREON @ CHARCOAL
		tr_moves FLARE_BLITZ, DOUBLE_EDGE, SMOKESCREEN, ROCK_SMASH
	tr_mon LEVEL_FROM_BADGES + 5, LEAFEON @ MIRACLE_SEED
		tr_moves SEED_BOMB, SWORDS_DANCE, HEALINGLIGHT, X_SCISSOR
	tr_mon LEVEL_FROM_BADGES + 5, GLACEON @ NEVERMELTICE
		tr_moves ICE_BEAM, MIRROR_COAT, RECOVER, QUICK_ATTACK
	tr_mon LEVEL_FROM_BADGES + 7, PORYGON2 @ EVIOLITE
...
YellowGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 11, "Omny", OMASTAR @ WISE_GLASSES, FEMALE
		tr_extra SHELL_ARMOR
		tr_moves SCALD, ANCIENTPOWER, SPIKES, ICE_BEAM
	tr_mon LEVEL_FROM_BADGES + 9, "Ratty", RATICATE @ KINGS_ROCK, FEMALE
		tr_extra GUTS, ATK_UP_SATK_DOWN
		tr_moves SWORDS_DANCE, QUICK_ATTACK, SUPER_FANG, CRUNCH
	tr_mon LEVEL_FROM_BADGES + 7, "Kitty", BUTTERFREE @ BRIGHTPOWDER, FEMALE
		tr_extra TINTED_LENS, SATK_UP_ATK_DOWN
	...
	tr_mon LEVEL_FROM_BADGES + 8, "Gravvy", GOLEM @ MUSCLE_BAND, FEMALE
		tr_extra STURDY, ATK_UP_SATK_DOWN
...
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 19, ARTICUNO @ BRIGHTPOWDER, MALE
		tr_moves ICE_BEAM, AIR_SLASH, ANCIENTPOWER, REFLECT
	tr_mon LEVEL_FROM_BADGES + 15, CHARIZARD @ DRAGON_FANG, MALE
=======
	tr_mon LEVEL_FROM_BADGES + 8, ARTICUNO @ BRIGHTPOWDER, MALE
		tr_moves ICE_BEAM, AIR_SLASH, ANCIENTPOWER, REFLECT
	tr_mon LEVEL_FROM_BADGES + 4, CHARIZARD @ DRAGON_FANG, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 8, ARTICUNO @ BRIGHTPOWDER, MALE
		tr_moves ICE_BEAM, AIR_SLASH, ANCIENTPOWER, REFLECT
...
=======
	tr_mon LEVEL_FROM_BADGES + 6, DRAGONITE @ LEFTOVERS, MALE
		tr_moves DRAGON_DANCE, OUTRAGE, AQUA_TAIL, EARTHQUAKE
	tr_mon LEVEL_FROM_BADGES + 5, TYRANITAR @ KINGS_ROCK, MALE
		tr_moves EARTHQUAKE, STONE_EDGE, CRUNCH, SCARY_FACE
	tr_mon LEVEL_FROM_BADGES + 4, HONCHKROW @ QUICK_CLAW, MALE
		tr_moves NASTY_PLOT, DARK_PULSE, CONFUSE_RAY, PURSUIT
	tr_mon LEVEL_FROM_BADGES + 8, ZAPDOS @ SHARP_BEAK, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 6, DRAGONITE @ LEFTOVERS, MALE
		tr_moves DRAGON_DANCE, OUTRAGE, AQUA_TAIL, EARTHQUAKE
...
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 22, ARTICUNO @ BRIGHTPOWDER, MALE
		tr_moves ICE_BEAM, AIR_SLASH, ANCIENTPOWER, REFLECT
	tr_mon LEVEL_FROM_BADGES + 17, CHARIZARD @ DRAGON_FANG, MALE
=======
	tr_mon LEVEL_FROM_BADGES + 10, ARTICUNO @ BRIGHTPOWDER, MALE
		tr_moves ICE_BEAM, AIR_SLASH, ANCIENTPOWER, REFLECT
	tr_mon LEVEL_FROM_BADGES + 6, CHARIZARD @ DRAGON_FANG, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 10, ARTICUNO @ BRIGHTPOWDER, MALE
		tr_moves ICE_BEAM, AIR_SLASH, ANCIENTPOWER, REFLECT
...
<<<<<<< HEAD
<<<<<<< HEAD
	tr_mon LEVEL_FROM_BADGES + 19, DRAGONITE @ LEFTOVERS, MALE
		tr_moves DRAGON_DANCE, OUTRAGE, AQUA_TAIL, EARTHQUAKE
	tr_mon LEVEL_FROM_BADGES + 18, TYRANITAR @ KINGS_ROCK, MALE
		tr_moves EARTHQUAKE, STONE_EDGE, CRUNCH, SCARY_FACE
	tr_mon LEVEL_FROM_BADGES + 17, PORYGON_Z @ QUICK_CLAW, MALE
		tr_moves NASTY_PLOT, DARK_PULSE, TRI_ATTACK, THUNDERBOLT
	tr_mon LEVEL_FROM_BADGES + 22, ZAPDOS @ SHARP_BEAK, MALE
=======
	tr_mon LEVEL_FROM_BADGES + 8, DRAGONITE @ LEFTOVERS, MALE
		tr_moves DRAGON_DANCE, OUTRAGE, AQUA_TAIL, EARTHQUAKE
	tr_mon LEVEL_FROM_BADGES + 7, TYRANITAR @ KINGS_ROCK, MALE
		tr_moves EARTHQUAKE, STONE_EDGE, CRUNCH, SCARY_FACE
	tr_mon LEVEL_FROM_BADGES + 6, PORYGON_Z @ QUICK_CLAW, MALE
		tr_moves NASTY_PLOT, DARK_PULSE, TRI_ATTACK, THUNDERBOLT
	tr_mon LEVEL_FROM_BADGES + 10, ZAPDOS @ SHARP_BEAK, MALE
>>>>>>> 070b40c543261ce6b59b6547ae33547af20c12ed
=======
	tr_mon LEVEL_FROM_BADGES + 8, DRAGONITE @ LEFTOVERS, MALE
		tr_moves DRAGON_DANCE, OUTRAGE, AQUA_TAIL, EARTHQUAKE
...
ReiGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 6, FLAREON @ MUSCLE_BAND
		tr_evs 68 Atk, 252 Spe
		tr_moves QUICK_ATTACK, ROCK_SMASH, DOUBLE_EDGE, FLARE_BLITZ
	tr_mon LEVEL_FROM_BADGES + 5, HONCHKROW @ BLACKGLASSES
		tr_evs 68 Atk, 252 Spe
		tr_moves DRILL_PECK, SUCKER_PUNCH, PURSUIT, BRAVE_BIRD
	tr_mon LEVEL_FROM_BADGES + 4, NOCTOWL @ QUICK_CLAW
		tr_evs 68 SAt, 252 Spe
		tr_moves SHADOW_BALL, AIR_SLASH, HYPNOSIS, DREAM_EATER
	tr_mon LEVEL_FROM_BADGES + 4, ALAKAZAM @ WISE_GLASSES
		tr_evs 68 SAt, 252 Spe
		tr_moves PSYCHIC_M, FOCUS_BLAST, SHADOW_BALL, THUNDER_WAVE
	tr_mon LEVEL_FROM_BADGES + 5, RAPIDASH @ KINGS_ROCK
		tr_evs 68 HP, 252 Spe
		tr_moves FIRE_BLAST, MEGAHORN, POISON_JAB, WILL_O_WISP
	tr_mon LEVEL_FROM_BADGES + 7, NINETALES @ LEFTOVERS
		tr_evs 68 SAt, 252 Spe
		tr_moves NASTY_PLOT, FLAMETHROWER, DARK_PULSE, SHADOW_BALL
	end_trainer

	def_trainer 3, "Maiden Rei"
	tr_mon LEVEL_FROM_BADGES + 9, FLAREON @ MUSCLE_BAND
		tr_moves QUICK_ATTACK, ROCK_SMASH, DOUBLE_EDGE, FLARE_BLITZ
	tr_mon LEVEL_FROM_BADGES + 8, HONCHKROW @ BLACKGLASSES
		tr_moves DRILL_PECK, SUCKER_PUNCH, PURSUIT, BRAVE_BIRD
	tr_mon LEVEL_FROM_BADGES + 7, NOCTOWL @ QUICK_CLAW
		tr_moves SHADOW_BALL, AIR_SLASH, HYPNOSIS, DREAM_EATER
	tr_mon LEVEL_FROM_BADGES + 7, ALAKAZAM @ WISE_GLASSES
		tr_moves PSYCHIC_M, FOCUS_BLAST, SHADOW_BALL, THUNDER_WAVE
	tr_mon LEVEL_FROM_BADGES + 8, RAPIDASH @ KINGS_ROCK
