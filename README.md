...
## The current version of this fork is based on the 3.2.0 release with some fixes from 3.2.1 (commit d6a4e68).
...
![beldumpokedex](screenshots/beldumpokedex.png)
![cynthiasgarchomp](screenshots/cynthiasgarchomp.png)
![miloticpog](screenshots/miloticpog.png)
![pikachucoloredpichu](screenshots/pikachucoloredpichu.png)

![newmusic](screenshots/newmusic.png)
![rioluegg](screenshots/rioluegg.png)
![saturdaytorkoal](screenshots/saturdaytorkoal.png)
![sundaygible](screenshots/sundaygible.png)
